...
class Post_Deployment_Hook {
	...
	public function __construct() {
		...
		$this->plugin_name = 'post-deployment-hook';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-post-deployment-hook-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-post-deployment-hook-admin.php';
	 ...
	 *
	 * Uses the Post_Deployment_Hook_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Post_Deployment_Hook_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Post_Deployment_Hook_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Post_Deployment_Hook_Public( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'after_setup_theme', $plugin_public, 'execute_webhook_actions' );
